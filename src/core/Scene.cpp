...
vec3 Scene::doPathTracing(Ray ray) const
{
	...
	do {
		...
		mask *= hit.material.diffuseColor * hit.material.brdf(newRay.dir, -ray.dir, hit.normal) * glm::max(glm::dot(hit.normal, newRay.dir), 0.0f) / probabilityBounce / russianRoulette;
